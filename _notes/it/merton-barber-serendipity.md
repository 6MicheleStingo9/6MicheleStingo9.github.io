...
La metà che regge tutto è **e per sagacia**. Serendipità non è mai stata un sinonimo di fortuna: è l'accidente più la mente preparata che riconosce quanto vale. Merton aveva già dato alla cosa una forma tecnica, il _serendipity pattern_ della ricerca: il dato imprevisto, anomalo e strategico che diventa l'occasione di una teoria nuova. È la versione rigorosa del «la distrazione è un metodo» di [[Un manifesto smarrito|il manifesto smarrito]], e la ragione per cui seguire un'adiacenza è un metodo e non un andare alla deriva.

Poi il libro fa esattamente quello di cui parla. Scritto nel 1958, resta inedito per più di quarant'anni e riaffiora alla fine in italiano, prima che nella propria lingua; e l'«originale» inglese in certi punti è stato ricostruito da pagine consumate dal tempo e ritradotto dall'italiano. Uno studio su una parola che ha vagato prima di trovare casa, il quale a sua volta ha vagato prima di trovarne una. Non esiste oggetto più adatto a un ufficio oggetti smarriti: uno studio sulla scoperta non cercata, rimasto a lungo non cercato. (Per un'altra parola perduta e inseguita attraverso la cultura europea, si veda [[Umberto Eco - La ricerca della lingua perfetta]].)
