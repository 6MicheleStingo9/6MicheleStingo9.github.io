...
permalink: /notes/wittgenstein-tractatus/
description: "The early Wittgenstein: language as a picture of the world, up to the limit where it must fall silent."
---

**[Ludwig Wittgenstein](https://en.wikipedia.org/wiki/Ludwig_Wittgenstein), _[Tractatus Logico-Philosophicus](https://en.wikipedia.org/wiki/Tractatus_Logico-Philosophicus)_** — first published as _Logisch-Philosophische Abhandlung_, in _Annalen der Naturphilosophie_, 1921. English translation: trans. C.K. Ogden (with F.P. Ramsey), London: Kegan Paul, 1922; standard modern translation, trans. D.F. Pears & B.F. McGuinness, London: Routledge & Kegan Paul, 1961.
...
> _What we cannot speak about we must pass over in silence._

That silence is the point the misplaced manifesto keeps "an ear for": the boundary of what a symbolic system can represent at all. The later Wittgenstein would tear the picture theory down and begin again from use — see [[Ludwig Wittgenstein - Philosophical Investigations]].
